...
Where:
- `<midi_input>`: Full path to the input MIDI file (e.g., `instances/1.mid`).
...
### Example Command
```bash
python main.py instances/1.mid 42 0.8 20
```
...
The script prints **a single scalar value** to standard output:
```
0.0833
```
Where:

- This value corresponds to the **tonal coherence loss** (range 0–1), where lower values indicate better tonal coherence with respect to the input progression.
